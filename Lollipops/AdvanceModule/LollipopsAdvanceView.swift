...
struct LollipopsAdvanceView: View {
    @StateObject var advanceModel =  LollipopsAdvanceViewModel()
...
#Preview {
    ...
    return LollipopsAdvanceView(navigationPath: .constant(navigationPath))
}
