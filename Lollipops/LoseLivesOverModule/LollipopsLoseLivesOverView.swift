...
struct LollipopsLoseLivesOverView: View {
    @StateObject var loseLivesOverModel =  LollipopsLoseLivesOverViewModel()
    ...
    var body: some View {
        ...
        .onAppear {
            LollipopsUserDefaultsManager().loseLevel()
        }
...
#Preview {
    ...
    return LollipopsLoseLivesOverView(navigationPath: .constant(navigationPath))
}
